...
<section class="page-title bg-dark-overlay text-center" style="background-image: url({{asset('img/page-title/blog.jpg')}});">
    <div class="container">
        <div class="page-title__holder">
            ...
            <p class="page-title__subtitle">Various Skill Programmes Conducted</p>
        </div>
    </div>
                        ...
                        <a href="/skill">
                            ...
                            <div class="hover-overlay">
                                <div class="project__description">
                                    <h3 class="project__title">Skill Name</h3>
                                    <span class="project__date">Skill Conducted Date</span>
                                </div>
                            </div>
                        </a>              
                    </div>                  
