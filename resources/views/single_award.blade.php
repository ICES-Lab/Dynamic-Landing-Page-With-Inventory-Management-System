    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8 project__info mb-md-40">
                ...
                <h1>Acheivement Team Details</h1>
            ...
            <div class="col-lg-4 project__details">
                <ul class="project__meta">
                    <li class="project__meta-item">
                        <span class="project__meta-label">Awarded By:</span>
                        <span class="project__meta-value">Bannari Amman Institute Of Technology</span>
                    </li>
                    <li class="project__meta-item">
                        <span class="project__meta-label">Awarded Date:</span>
                        <span class="project__meta-value">05.04.2017</span>
                    </li>								
                    <li class="project__meta-item">
                        <span class="project__meta-label">Awarded Place:</span>
                        <span class="project__meta-value">First</span>
                    </li>
                    <li class="project__meta-item">
                        <span class="project__meta-label">Awarded Price:</span>
                        <span class="project__meta-value">$30000</span>
                    </li>
                </ul>
